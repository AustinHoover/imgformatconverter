package electrosphere.main.bmp;
...
import electrosphere.main.bmp.BMPInfo.BMP_FORMAT;
...
public class BMPWriter {
    ...
    public static void writeBMP(File file, BufferedImage image, String formatRaw) {
